  ...
  return (
    <footer id="contact" className="py-20 px-8 md:px-20 font-garet text-white">
      <div className="max-w-3xl mx-auto space-y-8">
        <a href="https://www.tiendanube.com/partners/Marlocomunica" target="_blank" rel="noopener noreferrer" className="flex items-center gap-6 group hover:bg-white/10 p-4 rounded-xl transition-colors">
        ...
        <a href="https://marlocomunica.mitiendanube.com/productos/curso-ebook-canva-para-principiantes/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-6 group hover:bg-white/10 p-4 rounded-xl transition-colors">
          <div className="w-24 h-12 flex items-center justify-center">
